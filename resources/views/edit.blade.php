                ...
                <form action="{{ route('update', $people->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            @enderror
                            <input type="text" name="provinsi" id="provinsi" class="form-input @error('provinsi') is-invalid @enderror" placeholder="Provinsi *" value="{{ old('provinsi',$people->provinsi) }}" required>
                            @error('provinsi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
